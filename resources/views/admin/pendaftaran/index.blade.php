          ...
          <tbody class="divide-y divide-slate-100">
            ...
            <tr class="even:bg-slate-50 hover:bg-slate-50/50 transition-colors">
              ...
              <td class="p-4 space-x-2">
                <a href="{{ route('pendaftaran.edit', $item) }}" class="inline-flex items-center justify-center gap-1 px-3 py-1 bg-primary text-white rounded-lg text-xs font-semibold hover:bg-primary-dark transition-all">
                  <svg class="w-3.5 h-3.5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                  Verifikasi
                </a>
